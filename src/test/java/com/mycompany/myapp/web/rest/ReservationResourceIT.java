...
class ReservationResourceIT {
    ...
    public static Reservation createEntity(EntityManager em) {
        Reservation reservation = new Reservation().date(DEFAULT_DATE).etat(DEFAULT_ETAT);
        return reservation;
    }
    ...
    public static Reservation createUpdatedEntity(EntityManager em) {
        Reservation reservation = new Reservation().date(UPDATED_DATE).etat(UPDATED_ETAT);
        return reservation;
    }
    ...
    void putExistingReservation() throws Exception {
        ...
        updatedReservation.date(UPDATED_DATE).etat(UPDATED_ETAT);
    ...
    void partialUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.date(UPDATED_DATE).etat(UPDATED_ETAT);
