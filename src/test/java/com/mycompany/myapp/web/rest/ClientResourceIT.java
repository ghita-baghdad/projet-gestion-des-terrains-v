...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nomClient(DEFAULT_NOM_CLIENT).prenom(DEFAULT_PRENOM).email(DEFAULT_EMAIL).password(DEFAULT_PASSWORD);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nomClient(UPDATED_NOM_CLIENT).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nomClient(UPDATED_NOM_CLIENT).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nomClient(UPDATED_NOM_CLIENT).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
