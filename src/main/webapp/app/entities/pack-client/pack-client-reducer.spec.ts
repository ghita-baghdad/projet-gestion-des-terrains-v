...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKCLIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKCLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKCLIENT actions', async () => {
      const expectedActions = [
        {
