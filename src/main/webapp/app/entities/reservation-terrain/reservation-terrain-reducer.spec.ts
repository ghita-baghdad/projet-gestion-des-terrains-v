...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reservation-terrain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVATIONTERRAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESERVATIONTERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESERVATIONTERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESERVATIONTERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESERVATIONTERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESERVATIONTERRAIN actions', async () => {
      const expectedActions = [
        {
