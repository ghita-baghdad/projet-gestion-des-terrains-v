...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ville.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VILLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VILLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VILLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VILLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VILLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VILLE actions', async () => {
      const expectedActions = [
        {
