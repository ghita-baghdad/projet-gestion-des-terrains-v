  ...
  return (
    <div>
      <h2 id="ville-heading" data-cy="VilleHeading">
        <Translate contentKey="appApp.ville.home.title">Villes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="appApp.ville.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/ville/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="appApp.ville.home.createLabel">Create new Ville</Translate>
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {villeList && villeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th className="hand" onClick={sort('nomVille')}>
                  <Translate contentKey="appApp.ville.nomVille">Nom Ville</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nomVille')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="appApp.ville.home.notFound">No Villes found</Translate>
            </div>
          )
        )}
      </div>
